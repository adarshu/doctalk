<?
	...
	class RestClient
	{
		...
		private $recvcookies = array();

		private $method = "GET";
		private $params = null;
		private $sendcookies = array();
		...
		private function __construct()
		{
			...
			curl_setopt($this->curl, CURLOPT_HTTPHEADER, array("Accept: application/xml"));
		}
		...
		public function execute()
		{
			...
			if ($this->sendcookies) {
				$cookie_string = "";
				foreach ($this->sendcookies as $k => $v) {
					$cookie_string .= "$k=$v;";
				}
...
*/
		...
		private function treatResponse($r)
		{
			...
			$this->recvcookies = $this->parseCookies($parts[0]);
...
*/
		 ...
		 * @return RestClient
		 */
		public static function post($url, $params = null, array $cookies = null, $user = null, $pwd = null, $contentType = "multipart/form-data")
		{
			return self::call("POST", $url, $params, $cookies, $user, $pwd, $contentType);
		}

		public static function post2($url, $body, array $cookies = null, $user = null, $pwd = null, $contentType = "null")
		{
			return self::call("POST2", $url, $body, $cookies, $user, $pwd, $contentType);
		}
		 ...
		 * @return RestClient
		 */
		public static function put($url, $body, array $cookies = null, $user = null, $pwd = null, $contentType = null)
		{
			return self::call("PUT", $url, $body, $cookies, $user, $pwd, $contentType);
		}
		 ...
		 * @return RestClient
		 */
		public static function get($url, array $params = null, array $cookies = null, $user = null, $pwd = null)
		{
			return self::call("GET", $url, $params, $cookies, $user, $pwd);
		}
		 ...
		 * @return RestClient
		 */
		public static function delete($url, array $params = null, array $cookies = null, $user = null, $pwd = null)
		{
			return self::call("DELETE", $url, $params, $cookies, $user, $pwd);
		}
		 ...
		 * @return RestClient
		 */
		public static function call($method, $url, $body, $cookies, $user = null, $pwd = null, $contentType = null)
		{
			return self::createClient($url)->setParameters($body)->setCookies($cookies)->setMethod($method)->setCredentials($user, $pwd)->setContentType($contentType)->execute()->close();
		}
	}
